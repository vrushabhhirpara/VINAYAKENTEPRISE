        ...
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-8">
          ...
          <div>
            ...
            <ul className="space-y-2">
              ...
              <li>
                <Link to="/products/pharmaceuticals" className="text-gray-300 hover:text-primary-light transition-colors">
                  Pharmaceuticals
                </Link>
              </li>
              <li>
                <Link to="/products/textile" className="text-gray-300 hover:text-primary-light transition-colors">
                  Textile
                </Link>
              </li>
              <li>
                <Link to="/products/industrial" className="text-gray-300 hover:text-primary-light transition-colors">
                  Industrial Products
                </Link>
              </li>
              <li>
          ...
          <div>
            ...
            <ul className="space-y-3">
              ...
              <li className="flex items-center space-x-3">
                ...
                <span className="text-gray-300">vinayakenterprise2011@gmail.com</span>
              </li>
            </ul>
          </div>
        </div>
